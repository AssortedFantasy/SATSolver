...
#line 165 "parse.tab.c" /* yacc.c:355  */
};
...
#line 182 "parse.tab.c" /* yacc.c:358  */
...
{
       0,    75,    75,    77,    82,    83,    84,    85,    86,    87,
      88,    91,    96,   101,   105,   110,   115,   123,   128,   133,
     138,   146,   150,   160,   168,   173,   182
};
#endif
...
{
  "$end", "error", "$undefined", "XNOR", "IMPL", "XOR", "OR", "AND",
  "POST_NEG", "DUAL", "PRE_NEG", "LITERAL", "VARIABLE", "O_BRACE",
  "C_BRACE", "$accept", "commands", "expression", "paren_expression",
...
{
       7,   -10,     3,    24,     7,    10,    23,    55,   -11,   -11,
     -11,   -11,   -11,   -11,   -11,   -11,   -11,   -11,   -11,     2,
     -11,     7,     7,     7,     7,     7,    23,   -11,   -11,   -11,
      33,    42,    49,    49,     7
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       7,    10,     8,     9,    15,    12,    25,    14,    11,     0,
       1,     0,     0,     0,     0,     0,    19,    24,    26,    17,
      22,    23,    21,    20,    18
};
...
{
       6,    14,    15,     4,    19,    21,    22,    23,    24,    25,
      20,    17,     1,     2,     3,     4,    29,     1,     2,     3,
       4,    30,    31,    32,    33,    34,    21,    22,    23,    24,
      25,    16,    18,     1,     2,     3,     4,    22,    23,    24,
      25,     0,     0,     1,     2,     3,     4,    23,    24,    25,
       0,     0,     1,     2,     3,     4,    25,     0,     0,     1,
       2,     3,     4,    27,    28
};

static const yytype_int8 yycheck[] =
{
       0,    11,    12,    13,     4,     3,     4,     5,     6,     7,
       0,     8,    10,    11,    12,    13,    14,    10,    11,    12,
      13,    21,    22,    23,    24,    25,     3,     4,     5,     6,
       7,     1,     8,    10,    11,    12,    13,     4,     5,     6,
       7,    -1,    -1,    10,    11,    12,    13,     5,     6,     7,
      -1,    -1,    10,    11,    12,    13,     7,    -1,    -1,    10,
      11,    12,    13,     8,     9
};
...
static const yytype_uint8 yystos[] =
{
      ...
      21,    22,    23,    24,    11,    12,    18,     8,     8,    17,
       0,     3,     4,     5,     6,     7,    17,     8,     9,    14,
      17,    17,    17,    17,    17
};
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, expression* result)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (result);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, expression* result)
{
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, expression* result)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, expression* result)
{
  YYUSE (yyvaluep);
  YYUSE (result);
  if (!yymsg)
